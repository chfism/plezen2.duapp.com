...
(function (global) {
    //从页面读取数据库的数据保存在localStorage,供strut.startup/main.js调用，需优化
    if (this.document.getElementById('plezencontent')) {
        var plezendata = this.document.getElementById('plezencontent').value;
        if (plezendata != "undefined") {
            localStorage.setItem('strut-exitsave', plezendata);
        }
    }
