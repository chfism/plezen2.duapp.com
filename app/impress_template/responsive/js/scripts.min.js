...
(function (e, t) {
    ...
    function F(e, t, n) {
        ...
        if (t) {
            r = n ? u[a] : u[a].data;
            if (r) {
                if (!y.isArray(t))if (t in r)t = [t]; else {
                    t = y.camelCase(t);
                    t in r ? t = [t] : t = t.split(" ")
                } else t = t.concat(y.map(t, y.camelCase));
    ...
    function en(e, t) {
        e = t || e;
        return y.css(e, "display") === "none" || !y.contains(e.ownerDocument, e)
    }
    ...
    function tn(e, t) {
        ...
        for (; i < s; i++) {
            ...
            if (t) {
                !r[i] && n.style.display === "none" && (n.style.display = "");
                n.style.display === "" && en(n) && (r[i] = y._data(n, "olddisplay", on(n.nodeName)))
            } else!r[i] && !en(n) && y._data(n, "olddisplay", y.css(n, "display"))
        }
        for (i = 0; i < s; i++) {
            n = e[i];
            if (!n.style)continue;
    ...
    function rn(e, t, n, r, i) {
        ...
        for (; s < 4; s += 2) {
            ...
            if (r) {
                n === "content" && (o -= y.css(e, "padding" + Gt[s], !0, i));
                n !== "margin" && (o -= y.css(e, "border" + Gt[s] + "Width", !0, i))
            } else {
                o += y.css(e, "padding" + Gt[s], !0, i);
    ...
    function On(e) {
        return function (t, n) {
            ...
            if (y.isFunction(n))while (r = s[i++])if (r[0] === "+") {
                r = r.slice(1) || "*";
                (e[r] = e[r] || []).unshift(n)
            } else(e[r] = e[r] || []).push(n)
        }
    ...
    function Yn(e, t, n) {
        ...
        y.fx.timer(y.extend(a, {elem: e, anim: f, queue: f.opts.queue}));
    ...
    var n, r, i = e.document, s = e.location, o = e.jQuery, u = e.$, a = {}, f = [], l = "1.9.0", c = f.concat, h = f.push, p = f.slice, d = f.indexOf, v = a.toString, m = a.hasOwnProperty, g = l.trim, y = function (e, t) {
        ...
        if (i.addEventListener) {
            ...
            i.detachEvent("onreadystatechange", M);
            y.ready()
        }
    };
    y.fn = y.prototype = {jquery: l, constructor: y, init: function (e, n, r) {
        ...
        if (y.isFunction(e))return r.ready(e);
        if (e.selector !== t) {
    ...
    y.extend = y.fn.extend = function () {
        ...
        for (; a < f; a++)if ((e = arguments[a]) != null)for (n in e) {
            ...
            i = e[n];
            if (u === i)continue;
            if (l && i && (y.isPlainObject(i) || (s = y.isArray(i)))) {
                if (s) {
                    s = !1;
                    o = r && y.isArray(r) ? r : []
                } else o = r && y.isPlainObject(r) ? r : {};
                u[n] = y.extend(l, o, i)
            } else i !== t && (u[n] = i)
        }
        return u
    ...
    y.extend({noConflict: function (t) {
        ...
        r = y.buildFragment([e], t, s);
        s && y(s).remove();
        return y.merge([], r.childNodes)
        ...
        (!r || !r.documentElement || r.getElementsByTagName("parsererror").length) && y.error("Invalid XML: " + n);
        return r
    }, noop: function () {
        ...
        var n = t || [];
        e != null && (_(Object(e)) ? y.merge(n, typeof e == "string" ? [e] : e) : h.call(n, e));
        return n
        ...
        if (!y.isFunction(e))return t;
        i = p.call(arguments, 2);
        s = function () {
    ...
    y.ready.promise = function (t) {
        if (!r) {
            r = y.Deferred();
            if (i.readyState === "complete")setTimeout(y.ready); else if (i.addEventListener) {
    ...
    y.Callbacks = function (e) {
        ...
        var n, r, i, s, o, u, a = [], f = !e.once && [], l = function (t) {
            ...
            a && y.each(arguments, function (e, t) {
                var n;
    ...
    y.support = function () {
        ...
        y(function () {
            ...
            if (e.getComputedStyle) {
                ...
                t.boxSizingReliable = (e.getComputedStyle(h, null) || {width: "4px"}).width === "4px";
    ...
    y.extend({cache: {}, expando: "jQuery" + (l + Math.random()).replace(/\D/g, ""), noData: {embed: !0, object: "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000", applet: !0}, hasData: function (e) {
        e = e.nodeType ? y.cache[e[y.expando]] : e[y.expando];
        return!!e && !q(e)
    }, data: function (e, t, n) {
        return j(e, t, n, !1)
    ...
    y.fn.extend({queue: function (e, n) {
        ...
        return arguments.length < r ? y.queue(this[0], e) : n === t ? this : this.each(function () {
    ...
    y.fn.extend({attr: function (e, t) {
        ...
        if (!arguments.length) {
            if (s) {
                n = y.valHooks[s.type] || y.valHooks[s.nodeName.toLowerCase()];
                if (n && "get"in n && (r = n.get(s, "value")) !== t)return r;
                r = s.value;
                return typeof r == "string" ? r.replace(W, "") : r == null ? "" : r
            }
            return
        }
        i = y.isFunction(e);
    ...
    y.extend({valHooks: {option: {get: function (e) {
        ...
        if (r === t) {
            if (s && o && "get"in s && (i = s.get(e, n)) !== null)return i;
            typeof e.getAttribute != "undefined" && (i = e.getAttribute(n));
            return i == null ? t : i
        }
        if (r !== null) {
            if (s && o && "set"in s && (i = s.set(e, r, n)) !== t)return i;
            e.setAttribute(n, r + "");
            return r
        }
        y.removeAttr(e, n)
    ...
    U = {get: function (e, n) {
        ...
        t === !1 ? y.removeAttr(e, n) : Q && K || !J.test(n) ? e.setAttribute(!K && y.propFix[n] || n, n) : e[y.camelCase("default-" + n)] = e[n] = !0;
        return n
    }};
    ...
    if (!K) {
        R = y.valHooks.button = {get: function (e, n) {
            var r = e.getAttributeNode(n);
    ...
    if (!y.support.hrefNormalized) {
        y.each(["href", "src", "width", "height"], function (e, n) {
    ...
    y.event = {global: {}, add: function (e, n, r, i, s) {
        ...
        while (l--) {
            ...
            h = y.event.special[d] || {};
            c = y.extend({type: d, origType: m, data: i, handler: r, guid: r.guid, selector: s, needsContext: s && y.expr.match.needsContext.test(s), namespace: v.join(".")}, o);
            if (!(p = f[d])) {
                p = f[d] = [];
                p.delegateCount = 0;
        ...
        while (f--) {
            ...
            if (o && !h.length) {
                (!c.teardown || c.teardown.call(e, d, m.handle) === !1) && y.removeEvent(e, p, m.handle);
                delete a[p]
            }
        }
        if (y.isEmptyObject(a)) {
            delete m.handle;
        ...
        while ((s = u[n++]) && !e.isPropagationStopped()) {
            ...
            r = 0;
            while ((o = s.handlers[r++]) && !e.isImmediatePropagationStopped())if (!e.namespace_re || e.namespace_re.test(o.namespace)) {
                e.handleObj = o;
                e.data = o.data;
    ...
    y.Event = function (e, t) {
        ...
        if (e && e.type) {
            ...
            this.type = e.type;
            this.isDefaultPrevented = e.defaultPrevented || e.returnValue === !1 || e.getPreventDefault && e.getPreventDefault() ? nt : rt
        } else this.type = e;
        t && y.extend(this, t);
    ...
    y.support.changeBubbles || (y.event.special.change = {setup: function () {
        ...
        y.event.add(this, "beforeactivate._change", function (e) {
            var t = e.target;
            if (G.test(t.nodeName) && !y._data(t, "changeBubbles")) {
                y.event.add(t, "change._change", function (e) {
    ...
    (function (e, t) {
        ...
        i = ut.selectors = {cacheLength: 50, createPseudo: st, match: V, find: {}, relative: {">": {dir: "parentNode", first: !0}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: !0}, "~": {dir: "previousSibling"}}, preFilter: {ATTR: function (e) {
            ...
            return function (r) {
                ...
                if (!t)return!0;
                i += "";
                return t === "=" ? i === n : t === "!=" ? i !== n : t === "^=" ? n && i.indexOf(n) === 0 : t === "*=" ? n && i.indexOf(n) > -1 : t === "$=" ? n && i.substr(i.length - n.length) === n : t === "~=" ? (" " + i + " ").indexOf(n) > -1 : t === "|=" ? i === n || i.substr(0, n.length + 1) === n + "-" : !1
            }
    ...
    y.extend({filter: function (e, t, n) {
        n && (e = ":not(" + e + ")");
        return t.length === 1 ? y.find.matchesSelector(t[0], e) ? [t[0]] : [] : y.find.matches(e, t)
    }, dir: function (e, n, r) {
        var i = [], s = e[n];
    ...
    y.fn.extend({text: function (e) {
        ...
        var n, r = 0;
        for (; (n = this[r]) != null; r++)if (!e || y.filter(e, [n]).length > 0) {
            !t && n.nodeType === 1 && y.cleanData(Ht(n));
            if (n.parentNode) {
                t && y.contains(n.ownerDocument, n) && _t(Ht(n, "script"));
        ...
        var t = y.isFunction(e);
        !t && typeof e != "string" && (e = y(e).not(this).detach());
        ...
        if (h) {
            ...
            if (s) {
                ...
                if (u) {
                    ...
                    for (l = 0; l < u; l++) {
                        a = o[l];
                        xt.test(a.type || "") && !y._data(a, "globalEval") && y.contains(f, a) && (a.src ? y.ajax({url: a.src, type: "GET", dataType: "script", async: !1, global: !1, "throws": !0}) : y.globalEval((a.text || a.textContent || a.innerHTML || "").replace(Nt, "")))
                    }
                }
                i = s = null
            }
    ...
    y.extend({clone: function (e, t, n) {
        ...
        if (y.support.html5Clone || y.isXMLDoc(e) || !dt.test("<" + e.nodeName + ">"))u = e.cloneNode(!0); else {
    ...
    y.extend({cssHooks: {opacity: {get: function (e, t) {
        ...
        o = typeof r;
        if (o === "string" && (s = $t.exec(r))) {
            r = (s[1] + 1) * s[2] + parseFloat(y.css(e, n));
            o = "number"
        }
        if (r == null || o === "number" && isNaN(r))return;
        o === "number" && !y.cssNumber[a] && (r += "px");
        !y.support.clearCloneStyle && r === "" && n.indexOf("background") === 0 && (f[n] = "inherit");
        ...
        n = y.cssProps[a] || (y.cssProps[a] = Zt(e.style, a));
        u = y.cssHooks[n] || y.cssHooks[a];
        u && "get"in u && (s = u.get(e, !0, r));
        s === t && (s = jt(e, n, i));
        s === "normal" && n in Qt && (s = Qt[n]);
        if (r) {
            o = parseFloat(s);
            return r === !0 || y.isNumeric(o) ? o || 0 : s
        }
        return s
    ...
    if (e.getComputedStyle) {
        ...
        jt = function (e, n, r) {
            ...
            if (u) {
                a === "" && !y.contains(e.ownerDocument, e) && (a = y.style(e, n));
                if (Vt.test(a) && Wt.test(n)) {
                    i = f.width;
                    s = f.minWidth;
                    o = f.maxWidth;
    ...
    y(function () {
        ...
        !y.support.pixelPosition && y.fn.position && y.each(["top", "left"], function (e, t) {
            y.cssHooks[t] = {get: function (e, n) {
                if (n) {
                    n = jt(e, t);
                    return Vt.test(n) ? y(e).position()[t] + "px" : n
                }
            }}
        })
    });
    ...
    y.fn.load = function (e, n, r) {
        ...
        if (y.isFunction(n)) {
            r = n;
            n = t
        } else n && typeof n == "object" && (s = "POST");
        u.length > 0 && y.ajax({url: e, type: s, dataType: "html", data: n}).done(function (e) {
            o = arguments;
    ...
    y.each(["get", "post"], function (e, n) {
        y[n] = function (e, r, i, s) {
            ...
            return y.ajax({url: e, type: n, dataType: s, data: r, success: i})
        }
    });
    y.extend({active: 0, lastModified: {}, etag: {}, ajaxSettings: {url: vn, type: "GET", isLocal: En.test(dn[1]), global: !0, processData: !0, async: !0, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: {"*": Ln, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"}, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText"}, converters: {"* text": e.String, "text html": !0, "text json": y.parseJSON, "text xml": y.parseXML}, flatOptions: {url: !0, context: !0}}, ajaxSetup: function (e, t) {
        ...
        if (!c.hasContent) {
            if (c.data) {
                i = c.url += (gn.test(i) ? "&" : "?") + c.data;
                delete c.data
            }
            c.cache === !1 && (c.url = bn.test(i) ? i.replace(bn, "$1_=" + mn++) : i + (gn.test(i) ? "&" : "?") + "_=" + mn++)
        }
        if (c.ifModified) {
            y.lastModified[i] && x.setRequestHeader("If-Modified-Since", y.lastModified[i]);
    ...
    y.ajaxPrefilter("json jsonp", function (n, r, i) {
        ...
        if (a || n.dataTypes[0] === "jsonp") {
            s = n.jsonpCallback = y.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback;
            a ? n[a] = n[a].replace(Bn, "$1" + s) : n.jsonp !== !1 && (n.url += (gn.test(n.url) ? "&" : "?") + n.jsonp + "=" + s);
            n.converters["script json"] = function () {
                u || y.error(s + " was not called");
                return u[0]
            };
            n.dataTypes[0] = "json";
            o = e[s];
    ...
    y.Tween = tr;
    tr.prototype = {constructor: tr, init: function (e, t, n, r, i, s) {
        this.elem = e;
        this.prop = n;
        this.easing = i || "swing";
        this.options = t;
    ...
    tr.propHooks = {_default: {get: function (e) {
        var t;
        if (e.elem[e.prop] == null || !!e.elem.style && e.elem.style[e.prop] != null) {
            t = y.css(e.elem, e.prop, "auto");
            return!t || t === "auto" ? 0 : t
        }
    ...
    y.fn.offset = function (e) {
        ...
        if (!o)return;
        n = o.documentElement;
        if (!y.contains(n, s))return i;
        typeof s.getBoundingClientRect != "undefined" && (i = s.getBoundingClientRect());
        r = rr(o);
        return{top: i.top + (r.pageYOffset || n.scrollTop) - (n.clientTop || 0), left: i.left + (r.pageXOffset || n.scrollLeft) - (n.clientLeft || 0)}
    };
    ...
    y.fn.extend({position: function () {
        ...
        if (y.css(r, "position") === "fixed")t = r.getBoundingClientRect(); else {
            e = this.offsetParent();
            t = this.offset();
        ...
        return{top: t.top - n.top - y.css(r, "marginTop", !0), left: t.left - n.left - y.css(r, "marginLeft", !0)}
        ...
        y.each({padding: "inner" + e, content: n, "": "outer" + e}, function (r, i) {
            y.fn[i] = function (i, s) {
                ...
                return y.access(this, function (n, r, i) {
                    var s;
                    if (y.isWindow(n))return n.document.documentElement["client" + e];
                    if (n.nodeType === 9) {
                        s = n.documentElement;
                        return Math.max(n.body["scroll" + e], s["scroll" + e], n.body["offset" + e], s["offset" + e], s["client" + e])
                    }
                    return i === t ? y.css(n, r, u) : y.style(n, r, i, u)
                }, n, o ? i : t, o, null)
            }
        })
    });
...
(function (e, t, n) {
    ...
    function x(e, t, n, r) {
        if (n == "d")return;
        if (!O(e))return;
        var i = u.exec(t), s = e.css(n) === "auto" ? 0 : e.css(n), o = typeof s == "string" ? A(s) : s, a = typeof t == "string" ? A(t) : t, f = r === !0 ? 0 : o, l = e.is(":hidden"), c = e.translation();
        n == "left" && (f = parseInt(o, 10) + c.x);
        n == "right" && (f = parseInt(o, 10) + c.x);
        n == "top" && (f = parseInt(o, 10) + c.y);
        n == "bottom" && (f = parseInt(o, 10) + c.y);
        if (!i && t == "show") {
            f = 1;
            l && e.css({display: e.context.tagName == "LI" ? "list-item" : "block", opacity: 0})
        } else!i && t == "hide" && (f = 0);
        if (i) {
            var h = parseFloat(i[2]);
            i[1] && (h = (i[1] === "-=" ? -1 : 1) * h + parseInt(f, 10));
            return h
        }
        return f
    }
    ...
    function T(e, t, n) {
        return(n === !0 || E === !0 && n !== !1) && w ? "translate3d(" + e + "px, " + t + "px, 0)" : "translate(" + e + "px," + t + "px)"
    }

    function N(t, n, r, s, o, u, a, l) {
        var h = t.data(c), p = h && !L(h) ? h : e.extend(!0, {}, f), d = o, v = e.inArray(n, i) > -1;
        if (v) {
            var m = p.meta, g = A(t.css(n)) || 0, y = n + "_o";
            d = o - g;
            m[n] = d;
            m[y] = t.css(n) == "auto" ? 0 + d : g + d || 0;
            p.meta = m;
            if (a && d === 0) {
                d = 0 - m[y];
                m[n] = d;
        ...
        return t.data(c, C(t, p, n, r, s, d, u, a, l))
    }

    function C(e, t, n, r, i, o, u, a, f) {
        var l = !1, c = u === !0 && a === !0;
        t = t || {};
        if (!t.original) {
            t.original = {};
        ...
        var h = t.meta, p = t.original, d = t.properties, v = t.secondary;
        for (var m = s.length - 1; m >= 0; m--) {
            var g = s[m] + "transition-property", y = s[m] + "transition-duration", b = s[m] + "transition-timing-function";
            n = c ? s[m] + "transform" : n;
            if (l) {
                p[g] = e.css(g) || "";
                p[y] = e.css(y) || "";
    ...
    function k(e) {
        for (var t in e)if ((t == "width" || t == "height") && (e[t] == "show" || e[t] == "hide" || e[t] == "toggle"))return!0;
        return!1
    }
    ...
    function M(t, n, i) {
        ...
        (t == "width" || t == "height" || t == "opacity") && parseFloat(n) === parseFloat(i.css(t)) && (s = !1);
        return s
    }

    var r = ["top", "right", "bottom", "left", "opacity", "height", "width"], i = ["top", "right", "bottom", "left"], s = ["-webkit-", "-moz-", "-o-", ""], o = ["avoidTransforms", "useTranslate3d", "leaveTransforms"], u = /^([+-]=)?([\d+-.]+)(.*)$/, a = /([A-Z])/g, f = {secondary: {}, meta: {top: 0, right: 0, bottom: 0, left: 0}}, l = "px", c = "jQe", h = "cubic-bezier(", p = ")", d = null, v = !1, m = document.body || document.documentElement, g = m.style, y = "webkitTransitionEnd oTransitionEnd transitionend", b = g.WebkitTransition !== undefined || g.MozTransition !== undefined || g.OTransition !== undefined || g.transition !== undefined, w = "WebKitCSSMatrix"in window && "m11"in new WebKitCSSMatrix, E = w;
    if (e.expr && e.expr.filters) {
        d = e.expr.filters.animated;
        e.expr.filters.animated = function (t) {
            return e(t).data("events") && e(t).data("events")[y] ? !0 : d.call(this, t)
        }
    }
    e.extend({toggle3DByDefault: function () {
        return E = !E
    ...
    e.fn.translation = function () {
        ...
        var e = this[0], t = window.getComputedStyle(e, null), n = {x: 0, y: 0};
        if (t)for (var r = s.length - 1; r >= 0; r--) {
            var i = t.getPropertyValue(s[r] + "transform");
            if (i && /matrix/i.test(i)) {
                var o = i.replace(/^matrix\(/i, "").split(/, |\)$/g);
                n = {x: parseInt(o[4], 10), y: parseInt(o[5], 10)};
                break
            }
        }
        return n
    };
    e.fn.animate = function (n, r, u, a) {
        n = n || {};
        var f = typeof n.bottom == "undefined" && typeof n.right == "undefined", d = e.speed(r, u, a), m = this, g = 0, w = function () {
            g--;
            g === 0 && typeof d.complete == "function" && d.complete.apply(m, arguments)
        }, E = typeof n.avoidCSSTransitions != "undefined" ? n.avoidCSSTransitions : v;
        return E === !0 || !b || L(n) || k(n) || d.duration <= 0 || e.fn.animate.defaults.avoidTransforms === !0 && n.avoidTransforms !== !1 ? t.apply(this, arguments) : this[d.queue === !0 ? "queue" : "each"](function () {
            var r = e(this), u = e.extend({}, d), a = function (t) {
                var o = r.data(c) || {original: {}}, u = {};
                if (t.eventPhase != 2)return;
                if (n.leaveTransforms !== !0) {
                    for (var a = s.length - 1; a >= 0; a--)u[s[a] + "transform"] = "";
                    if (f && typeof o.meta != "undefined")for (var h = 0, p; p = i[h]; ++h) {
                        u[p] = o.meta[p + "_o"] + l;
                        e(this).css(p, u[p])
                    }
                }
                r.unbind(y).css(o.original).css(u).data(c, null);
                n.opacity === "hide" && r.css({display: "none", opacity: ""});
                w.call(this)
            }, v = {bounce: h + "0.0, 0.35, .5, 1.3" + p, linear: "linear", swing: "ease-in-out", easeInQuad: h + "0.550, 0.085, 0.680, 0.530" + p, easeInCubic: h + "0.550, 0.055, 0.675, 0.190" + p, easeInQuart: h + "0.895, 0.030, 0.685, 0.220" + p, easeInQuint: h + "0.755, 0.050, 0.855, 0.060" + p, easeInSine: h + "0.470, 0.000, 0.745, 0.715" +
                p, easeInExpo: h + "0.950, 0.050, 0.795, 0.035" + p, easeInCirc: h + "0.600, 0.040, 0.980, 0.335" + p, easeInBack: h + "0.600, -0.280, 0.735, 0.045" + p, easeOutQuad: h + "0.250, 0.460, 0.450, 0.940" + p, easeOutCubic: h + "0.215, 0.610, 0.355, 1.000" + p, easeOutQuart: h + "0.165, 0.840, 0.440, 1.000" + p, easeOutQuint: h + "0.230, 1.000, 0.320, 1.000" + p, easeOutSine: h + "0.390, 0.575, 0.565, 1.000" + p, easeOutExpo: h + "0.190, 1.000, 0.220, 1.000" + p, easeOutCirc: h + "0.075, 0.820, 0.165, 1.000" + p, easeOutBack: h + "0.175, 0.885, 0.320, 1.275" + p, easeInOutQuad: h + "0.455, 0.030, 0.515, 0.955" + p, easeInOutCubic: h + "0.645, 0.045, 0.355, 1.000" + p, easeInOutQuart: h + "0.770, 0.000, 0.175, 1.000" + p, easeInOutQuint: h + "0.860, 0.000, 0.070, 1.000" + p, easeInOutSine: h + "0.445, 0.050, 0.550, 0.950" + p, easeInOutExpo: h + "1.000, 0.000, 0.000, 1.000" + p, easeInOutCirc: h + "0.785, 0.135, 0.150, 0.860" + p, easeInOutBack: h + "0.680, -0.550, 0.265, 1.550" + p}, m = {}, b = v[u.easing || "swing"] ? v[u.easing || "swing"] : u.easing || "swing";
            for (var E in n)if (e.inArray(E, o) === -1) {
                var S = e.inArray(E, i) > -1, T = x(r, n[E], E, S && n.avoidTransforms !== !0);
                n.avoidTransforms !== !0 && M(E, T, r) ? N(r, E, u.duration, b, S && n.avoidTransforms === !0 ? T + l : T, S && n.avoidTransforms !== !0, f, n.useTranslate3d === !0) : m[E] = n[E]
            }
            r.unbind(y);
            var C = r.data(c);
            if (C && !L(C) && !L(C.secondary)) {
                g++;
                r.css(C.properties);
                var k = C.secondary;
                setTimeout(function () {
            ...
            if (!L(m)) {
                g++;
                t.apply(r, [m, {duration: u.duration, easing: e.easing[u.easing] ? u.easing : e.easing.swing ? "swing" : "linear", complete: w, queue: u.queue}])
            }
            return!0
        })
    };
    e.fn.animate.defaults = {};
    e.fn.stop = function (t, r, i) {
        if (!b)return n.apply(this, [t, r]);
        t && this.queue([]);
        this.each(function () {
            var o = e(this), u = o.data(c);
            if (u && !L(u)) {
                var f, h = {};
                if (r) {
                    h = u.secondary;
                    if (!i && typeof u.meta.left_o !== undefined || typeof u.meta.top_o !== undefined) {
                        h.left = typeof u.meta.left_o !== undefined ? u.meta.left_o : "auto";
                        h.top = typeof u.meta.top_o !== undefined ? u.meta.top_o : "auto";
                        for (f = s.length - 1; f >= 0; f--)h[s[f] + "transform"] = ""
                    }
                } else if (!L(u.secondary)) {
                    var p = window.getComputedStyle(o[0], null);
                    if (p)for (var d in u.secondary)if (u.secondary.hasOwnProperty(d)) {
                        d = d.replace(a, "-$1").toLowerCase();
                        h[d] = p.getPropertyValue(d);
                        if (!i && /matrix/i.test(h[d])) {
                            var v = h[d].replace(/^matrix\(/i, "").split(/, |\)$/g);
                            h.left = parseFloat(v[4]) + parseFloat(o.css("left")) + l || "auto";
                            h.top = parseFloat(v[5]) + parseFloat(o.css("top")) + l || "auto";
                            for (f = s.length - 1; f >= 0; f--)h[s[f] + "transform"] = ""
                        }
                    }
                }
                o.unbind(y);
                o.css(u.original).css(h).data(c, null)
            } else n.apply(o, [t, r])
        });
        return this
    }
...
(function (e, t) {
    "use strict";
    var n = function () {
        var t = e.createElement("dummy").style, n = "Webkit Moz O ms Khtml".split(" "), r = {};
        return function (e) {
            if (typeof r[e] == "undefined") {
                var i = e.charAt(0).toUpperCase() + e.substr(1), s = (e + " " + n.join(i + " ") + i).split(" ");
                r[e] = null;
                for (var o in s)if (t[s[o]] !== undefined) {
                    r[e] = s[o];
                    break
                }
            }
        ...
        i.initCustomEvent(n, !0, !0, r);
        t.dispatchEvent(i)
    }, l = function (e) {
        return" translate3d(" + e.x + "px," + e.y + "px," + e.z + "px) "
    }, c = function (e, t) {
        var n = " rotateX(" + e.x + "deg) ", r = " rotateY(" + e.y + "deg) ", i = " rotateZ(" + e.z + "deg) ";
        ...
        var n = t.innerHeight / e.height, r = t.innerWidth / e.width, i = n > r ? r : n;
        e.maxScale && i > e.maxScale && (i = e.maxScale);
        e.minScale && i < e.minScale && (i = e.minScale);
        return i
    }, m = e.body, g = navigator.userAgent.toLowerCase(), y = n("perspective") !== null && m.classList && m.dataset
        //&& g.search(/(iphone)|(ipod)|(android)/) === -1
        ;
    if (!y)m.className += " impress-not-supported "; else {
        m.classList.remove("impress-not-supported");
        m.classList.add("impress-supported")
    }
    var b = {}, w = {width: 1024, height: 768, maxScale: 1, minScale: 0, perspective: 1e3, transitionDuration: 1e3}, E = function () {
        return!1
    }, S = t.impress = function (n) {
        if (!y)return{init: E, "goto": E, prev: E, next: E};
        n = n || "impress";
        if (b["impress-root-" + n])return b["impress-root-" + n];
        var g = {}, S = null, x = null, T = null, N = null, C = null, k = o(n), L = e.createElement("div"), A = !1, O = null, M = function (e) {
            if (O !== e) {
            ...
            var n = e.dataset, r = {translate: {x: s(n.x), y: s(n.y), z: s(n.z)}, rotate: {x: s(n.rotateX), y: s(n.rotateY), z: s(n.rotateZ || n.rotate)}, scale: s(n.scale, 1), el: e};
            e.id || (e.id = "step-" + (t + 1));
            g["impress-" + e.id] = r;
            i(e, {position: "absolute", transform: "translate(-50%,-50%)" + l(r.translate) + c(r.rotate) + h(r.scale), transformStyle: "preserve-3d"})
        }, P = function () {
            if (A)return;
            ...
            var o = k.dataset;
            N = {width: s(o.width, w.width), height: s(o.height, w.height), maxScale: s(o.maxScale, w.maxScale), minScale: s(o.minScale, w.minScale), perspective: s(o.perspective, w.perspective), transitionDuration: s(o.transitionDuration, w.transitionDuration)};
            C = v(N);
            ...
            i(m, {height: "100%", overflow: "hidden"});
            var l = {position: "absolute", transformOrigin: "top left", transition: "all 0s ease-in-out", transformStyle: "preserve-3d"};
            i(k, l);
            i(k, {top: "50%", left: "50%", transform: p(N.perspective / C) + h(C)});
            i(L, l);
            m.classList.remove("impress-disabled");
            m.classList.add("impress-enabled");
            T = a(".step", k);
            T.forEach(D);
            x = {translate: {x: 0, y: 0, z: 0}, rotate: {x: 0, y: 0, z: 0}, scale: 1};
            A = !0;
            f(k, "impress:init", {api: b["impress-root-" + n]})
        }, H = function (e) {
            typeof e == "number" ? e = e < 0 ? T[T.length + e] : T[e] : typeof e == "string" && (e = o(e));
            return e && e.id && g["impress-" + e.id] ? e : null
        }, B = null, j = function (e, n) {
            if (!A || !(e = H(e)))return!1;
            t.scrollTo(0, 0);
            ...
            var o = {rotate: {x: -r.rotate.x, y: -r.rotate.y, z: -r.rotate.z}, translate: {x: -r.translate.x, y: -r.translate.y, z: -r.translate.z}, scale: 1 / r.scale}, u = o.scale >= x.scale;
            n = s(n, N.transitionDuration);
            var a = n / 2;
            e === S && (C = v(N));
            var f = o.scale * C;
            S && S !== e && _(S);
            i(k, {transform: p(N.perspective / f) + h(f), transitionDuration: n + "ms", transitionDelay: (u ? a : 0) + "ms"});
            i(L, {transform: c(o.rotate, !0) + l(o.translate), transitionDuration: n + "ms", transitionDelay: (u ? 0 : a) + "ms"});
            if (x.scale === o.scale || x.rotate.x === o.rotate.x && x.rotate.y === o.rotate.y && x.rotate.z === o.rotate.z && x.translate.x === o.translate.x && x.translate.y === o.translate.y && x.translate.z === o.translate.z)a = 0;
            x = o;
            S = e;
            t.clearTimeout(B);
        ...
        k.addEventListener("impress:init", function () {
            ...
            t.addEventListener("hashchange", function () {
                t.location.hash !== e && j(d())
            }, !1);
            j(d() || T[0], 0)
        }, !1);
        m.classList.add("impress-disabled");
        return b["impress-root-" + n] = {init: P, "goto": j, next: I, prev: F}
    };
    S.supported = y
})(document, window);
(function (e, t) {
    ...
    e.addEventListener("impress:init", function (r) {
        ...
        e.addEventListener("keydown", function (e) {
            (e.keyCode === 9 || e.keyCode >= 32 && e.keyCode <= 34 || e.keyCode >= 37 && e.keyCode <= 40) && e.preventDefault()
        }, !1);
        ...
        e.addEventListener("click", function (t) {
            var n = t.target;
            while (n.tagName !== "A" && n !== e.documentElement)n = n.parentNode;
            if (n.tagName === "A") {
        ...
        e.addEventListener("click", function (t) {
            var n = t.target;
            while ((!n.classList.contains("step") || !!n.classList.contains("active")) && n !== e.documentElement)n = n.parentNode;
            i.goto(n) && t.preventDefault()
        }, !1);
        e.addEventListener("touchstart", function (e) {
            if (e.touches.length === 1) {
                var n = e.touches[0].clientX, r = t.innerWidth * .3, s = null;
                n < r ? s = i.prev() : n > t.innerWidth - r && (s = i.next());
                s && e.preventDefault()
            }
        }, !1);
...
(function (e, t) {
    "use strict";
    var n = '<!DOCTYPE html><html><head><link rel="stylesheet" type="text/css" media="screen" href="{{cssFile}}"></head><body><div id="console"><div id="views"><iframe id="slideView" scrolling="no"></iframe><iframe id="preView" scrolling="no"></iframe><div id="blocker"></div></div><div id="notes"></div></div></body></html>', r = "css/impressConsole.css", i = {}, s = !1, o = function (e) {
        return(e < 10 ? "0" : "") + e
    }, u = t.console = function (u) {
        u = u || "impress";
        if (i[u])return i[u];
        var a = e.getElementById(u), f = null, l = function () {
            var t = e.querySelector(".active").nextElementSibling, n = "";
            while (t) {
                n = t.attributes["class"];
                if (n && n.value.indexOf("step") !== -1)return t;
                t = t.nextElementSibling
            }
            return e.querySelector(".step")
        }, c = function () {
            if (f) {
                var t = e.querySelector(".active").querySelector(".notes");
                t ? t = t.innerHTML : t = "No notes for this step";
                f.document.getElementById("notes").innerHTML = t;
                var n = e.URL.substring(0, e.URL.search("#/")), r = n + "#" + e.querySelector(".active").id, i = n + "#" + l().id, s = f.document.getElementById("slideView");
                s.src !== r && (s.src = r);
                var o = f.document.getElementById("preView");
                o.src !== i && (o.src = i);
                f.document.getElementById("status").innerHTML = '<span style="color: red">Moving</span>'
            }
        }, h = function () {
            if (f) {
                var t = e.querySelector(".active").querySelector(".notes");
                t ? t = t.innerHTML : t = "No notes for this step";
                var n = f.document.getElementById("notes");
                n.innerHTML = t;
                n.scrollTop = 0;
                var r = e.URL.substring(0, e.URL.search("#/")), i = r + "#" + e.querySelector(".active").id, s = r + "#" + l().id, o = f.document.getElementById("slideView");
                o.src !== i && (o.src = i);
                var u = f.document.getElementById("preView");
                u.src !== s && (u.src = s);
                f.document.getElementById("status").innerHTML = '<span style="color: green">Ready</span>'
            }
        }, p = function () {
            var e = f.document.getElementById("notes");
            e.scrollTopMax - e.scrollTop > 20 ? e.scrollTop = e.scrollTop + e.clientHeight * .8 : impress().next()
        }, d = function () {
            f.timerStart = new Date
        }, v = function () {
            var e = new Date, t = e.getHours(), n = e.getMinutes(), r = e.getSeconds(), i = "";
            if (s) {
                i = t < 12 ? "AM" : "PM";
                t = t > 12 ? t - 12 : t;
                t = t == 0 ? 12 : t
            ...
            var u = o(t) + ":" + o(n) + ":" + o(r) + " " + i;
            f.document.getElementById("clock").firstChild.nodeValue = u;
            r = Math.floor((e - f.timerStart) / 1e3);
            n = Math.floor(r / 60);
            r = Math.floor(r % 60);
            f.document.getElementById("timer").firstChild.nodeValue = o(n) + "m " + o(r) + "s"
        }, m = function (e, t, n) {
            n === undefined && (n = f);
            n.document.addEventListener("keydown", function (t) {
                !t.ctrlKey && !t.altKey && !t.shiftKey && !t.metaKey && e.indexOf(t.keyCode) != -1 && t.preventDefault()
            }, !1);
            n.document.addEventListener("keyup", function (n) {
                if (!n.ctrlKey && !n.altKey && !n.shiftKey && !n.metaKey && e.indexOf(n.keyCode) != -1) {
                    t();
                    n.preventDefault()
                }
            }, !1)
        }, g = function () {
            if (top.isconsoleWindow)return;
            if (f && !f.closed)f.focus(); else {
                f = t.open();
                f.document.open();
                f.document.write(n.replace("{{cssFile}}", r));
                f.document.title = "Speaker Console (" + e.title + ")";
                f.impress = t.impress;
                f.isconsoleWindow = !0;
                f.timerStart = new Date;
                f.timerReset = d;
                f.clockInterval = setInterval('console("' + u + '").clockTick()', 1e3);
                m([33, 37, 38], impress().prev);
                m([34, 39, 40], impress().next);
                m([32], p);
                f.onbeforeunload = function () {
                    clearInterval(f.clockInterval)
                };
                c();
                h();
                f.document.close()
            ...
            e !== undefined && (r = e);
            a.addEventListener("impress:stepleave", c);
            a.addEventListener("impress:stepenter", h);
            t.onunload = function () {
                f && !f.closed && f.close()
            };
            m([80], g, t)
        };
        return i[u] = {init: y, open: g, clockTick: v, registerKeyEvent: m}
    }
})(document, window);
console().init("../css/impress.console.css");
window.Rainbow = function () {
    function l(e, t, n, r) {
        var i = e.getAttribute && e.getAttribute(t) || 0;
        if (!i) {
            n = e.attributes;
            for (r = 0; r < n.length; ++r)if (n[r].nodeName === t)return n[r].nodeValue
        }
        return i
    }
    ...
    function p(e) {
        var t = l(e, "data-language") || l(e.parentNode, "data-language");
        if (!t) {
    ...
    function v(e, t, n, r) {
        return n >= e && n < t ? !0 : r > e && r < t
    }

    function m(e, t, n, r) {
        return n == e && r == t ? !1 : n <= e && r >= t
    }
    ...
    function g(n, r) {
        for (var s in t[i]) {
            ...
            if (v(s, t[i][s], n, r))return!0
        }
        return!1
    }

    function y(e, t) {
        return'<span class="' + e.replace(/\./g, " ") + (a ? " " + a : "") + '">' + t + "</span>"
    }

    function b(e, t) {
        var n = 0, r;
        for (r = 1; r < t; ++r)e[r] && (n += e[r].length);
        return n
    }
    ...
    function w(n, r, s, u) {
        ...
        if (!a)return u();
        ++o;
        if (!r.name && typeof r["matches"][0] == "string") {
            r.name = r.matches[0];
            delete r.matches[0]
        }
        var f = a[0], l = a.index, c = a[0].length + l, h = function () {
            var e = function () {
                w(n, r, s, u)
            };
            return o % 100 > 0 ? e() : setTimeout(e, 0)
        };
        if (g(l, c))return h();
        var p = function (n) {
            r.name && (n = y(r.name, n));
            ...
            e[i][l] = {replace: a[0], "with": n};
            t[i][l] = c;
            h()
        }, d = T(r.matches), v = function (e, t, n) {
            if (e >= t.length)return n(f);
            var i = function () {
                v(++e, t, n)
            }, s = a[t[e]];
            if (!s)return i();
            var o = r.matches[t[e]], u = o.language, l = o.name && o.matches ? o.matches : o, c = function (n, r, s) {
                f = x(b(a, t[e]), n, s ? y(s, r) : r, f);
                i()
            };
            if (u)return k(s, u, function (e) {
                c(s, e)
            });
            if (typeof o == "string")return c(s, s, o);
            N(s, l.length ? l : [l], function (e) {
                c(s, e, o.matches ? o.name : 0)
            })
        };
        v(0, d, p)
    }
    ...
    function S(e) {
        var t = n[e] || [], r = n[s] || [];
        return E(e) ? t : t.concat(r)
    }

    function x(e, t, n, r) {
        var i = r.substr(e);
        return r.substr(0, e) + i.replace(t, n)
    }
    ...
    function N(n, r, s) {
        function o(r, u) {
            if (u < r.length)return w(r[u].pattern, r[u], n, function () {
                o(r, ++u)
            });
            C(n, function (n) {
                delete e[i];
    ...
    function C(t, n) {
        function r(t, n, s, o) {
            if (s < n.length) {
                ++u;
                var a = n[s], f = e[i][a];
                t = x(a, f.replace, f["with"], t);
                var l = function () {
                    r(t, n, ++s, o)
                };
                return u % 250 > 0 ? l() : setTimeout(l, 0)
            }
            o(t)
        }
    ...
    function L(n, r, i) {
        if (r < n.length) {
            ...
            if (!h(s, "rainbow") && o) {
                o = o.toLowerCase();
                c(s, "rainbow");
                return k(s.innerHTML, o, function (u) {
                    s.innerHTML = u;
                    e = {};
                    t = {};
                    f && f(s, o);
    ...
    function A(e, t) {
        e = e && typeof e.getElementsByTagName == "function" ? e : document;
        var n = e.getElementsByTagName("pre"), r = e.getElementsByTagName("code"), i, s = [];
        for (i = 0; i < r.length; ++i)s.push(r[i]);
        for (i = 0; i < n.length; ++i)n[i].getElementsByTagName("code").length || s.push(n[i]);
        L(s, 0, t)
    }

    var e = {}, t = {}, n = {}, r = {}, i = 0, s = 0, o = 0, u = 0, a, f;
    return{extend: function (e, t, i) {
        ...
        if (typeof arguments[0] == "string")return k(arguments[0], arguments[1], arguments[2]);
        if (typeof arguments[0] == "function")return A(0, arguments[0]);
        A(arguments[0], arguments[1])
    }}
}();
Rainbow.extend("c", [
    {name: "meta.preprocessor", matches: {1: [
...
Rainbow.extend("coffeescript", [
    ...
    {name: "string.regex", matches: {2: {name: "comment", pattern: /\#(.*?)\n/g}}, pattern: /(\/{3})([\s\S]*)\1/gm},
    {matches: {1: "keyword"}, pattern: /\b(in|when|is|isnt|of|not|unless|until|super)(?=\b)/gi},
    ...
    {matches: {1: "entity.name.function", 2: "keyword.operator", 3: {name: "function.argument.coffee", pattern: /([\@\w]+)/g}, 4: "keyword.function"}, pattern: /(\w+)\s{0,}(=|:)\s{0,}\((.*?)((-|=)&gt;)/gi},
    {matches: {1: {name: "function.argument.coffee", pattern: /([\@\w]+)/g}, 2: "keyword.function"}, pattern: /\s\((.*?)\)\s{0,}((-|=)&gt;)/gi},
    {matches: {1: "entity.name.function", 2: "keyword.operator", 3: "keyword.function"}, pattern: /(\w+)\s{0,}(=|:)\s{0,}((-|=)&gt;)/gi},
    {matches: {1: "storage.class", 2: "entity.name.class", 3: "storage.modifier.extends", 4: "entity.other.inherited-class"}, pattern: /\b(class)\s(\w+)(\sextends\s)?([\w\\]*)?\b/g},
...
Rainbow.extend("csharp", [
    ...
    {name: "keyword", pattern: /\b(abstract|add|alias|ascending|as|base|bool|break|byte|case|catch|char|checked|class|const|continue|decimal|default|delegate|descending|double|do|dynamic|else|enum|event|explicit|extern|false|finally|fixed|float|foreach|for|from|get|global|goto|group|if|implicit|int|interface|internal|into|in|is|join|let|lock|long|namespace|new|object|operator|orderby|out|override|params|partial|private|protected|public|readonly|ref|remove|return|sbyte|sealed|select|set|short|sizeof|stackalloc|static|string|struct|switch|this|throw|try|typeof|uint|unchecked|ulong|unsafe|ushort|using|value|var|virtual|void|volatile|where|while|yield)\b/g},
    {matches: {1: "keyword", 2: {name: "support.class", pattern: /\w+/g}}, pattern: /(typeof)\s([^\$].*?)(\)|;)/g},
    {matches: {1: "keyword.namespace", 2: {name: "support.namespace", pattern: /\w+/g}}, pattern: /\b(namespace)\s(.*?);/g},
    {matches: {1: "storage.modifier", 2: "storage.class", 3: "entity.name.class", 4: "storage.modifier.extends", 5: "entity.other.inherited-class"}, pattern: /\b(abstract|sealed)?\s?(class)\s(\w+)(\sextends\s)?([\w\\]*)?\s?\{?(\n|\})/g},
    {name: "keyword.static", pattern: /\b(static)\b/g},
    {matches: {1: "keyword.new", 2: {name: "support.class", pattern: /\w+/g}}, pattern: /\b(new)\s([^\$].*?)(?=\)|\(|;|&)/g},
...
Rainbow.extend("go", [
    ...
    {name: "comment", pattern: /\/\*[\s\S]*?\*\/|(\/\/)[\s\S]*?$/gm},
    {name: "constant.numeric", pattern: /\b(\d+(\.\d+)?(e(\+|\-)?\d+)?(f|d)?|0x[\da-f]+)\b/gi},
    {matches: {1: "keyword"}, pattern: /\b(break|c(ase|onst|ontinue)|d(efault|efer)|else|fallthrough|for|go(to)?|if|import|interface|map|package|range|return|select|struct|switch|type|var)(?=\(|\b)/gi},
    {name: "constant.language", pattern: /true|false|null|string|byte|rune|u?int(8|16|32|64)?|float(32|64)|complex(64|128)/g},
    {name: "keyword.operator", pattern: /\+|\!|\-|&(gt|lt|amp);|\||\*|\:?=/g},
    {matches: {1: "function.call"}, pattern: /(\w+?)(?=\()/g},
...
Rainbow.extend("haskell", [
    ...
    {matches: {1: "keyword", 2: "support.namespace"}, pattern: /\b(module)\s(\w+)\s[\(]?(\w+)?[\)?]\swhere/g},
    {name: "keyword.operator", pattern: /\+|\!|\-|&(gt|lt|amp);|\/\=|\||\@|\:|\.|\+{2}|\:|\*|\=|#|\.{2}|(\\)[a-zA-Z_]/g},
    {name: "keyword", pattern: /\b(case|class|foreign|hiding|qualified|data|family|default|deriving|do|else|if|import|in|infix|infixl|infixr|instance|let|in|otherwise|module|newtype|of|then|type|where)\b/g},
    {name: "keyword", pattern: /[\`][a-zA-Z_']*?[\`]/g},
    {matches: {1: "keyword", 2: "keyword.operator"}, pattern: /\b(infix|infixr|infixl)+\s\d+\s(\w+)*/g},
...
Rainbow.extend("java", [
    ...
    {matches: {1: "keyword", 2: "support.namespace"}, pattern: /(import|package)\s(.+)/g},
    ...
    {name: "operator", pattern: /(\+{1,2}|-{1,2}|~|!|\*|\/|%|(?:&lt;){1,2}|(?:&gt;){1,3}|instanceof|(?:&amp;){1,2}|\^|\|{1,2}|\?|:|(?:=|!|\+|-|\*|\/|%|\^|\||(?:&lt;){1,2}|(?:&gt;){1,3})?=)/g}
], !0);
...
Rainbow.extend("lua", [
    ...
    {name: "constant.numeric", pattern: /\b(\d+(\.\d+)?(e(\+|\-)?\d+)?(f|d)?|0x[\da-f]+)\b/gi},
    {matches: {1: "keyword"}, pattern: /\b((a|e)nd|in|repeat|break|local|return|do|for|then|else(if)?|function|not|if|or|until|while)(?=\(|\b)/gi},
    {name: "constant.language", pattern: /true|false|nil/g},
    {name: "keyword.operator", pattern: /\+|\!|\-|&(gt|lt|amp);|\||\*|\=|#|\.{2}/g},
    {matches: {1: "storage.function", 2: "entity.name.function"}, pattern: /(function)\s+(\w+[\:|\.]?\w+?)(?=\()/g},
    {matches: {1: "support.function"}, pattern: /\b(print|require|module|\w+\.\w+)(?=\()/g}
]);
Rainbow.extend("php", [
    {name: "support", pattern: /\becho\b/g},
    {matches: {1: "variable.dollar-sign", 2: "variable"}, pattern: /(\$)(\w+)\b/g},
    {name: "constant.language", pattern: /true|false|null/ig},
    {name: "constant", pattern: /\b[A-Z0-9_]{2,}\b/g},
    {name: "keyword.dot", pattern: /\./g},
    {name: "keyword", pattern: /\b(continue|break|die|end(for(each)?|switch|if)|case|require(_once)?|include(_once)?)(?=\(|\b)/g},
    {matches: {1: "keyword", 2: {name: "support.class", pattern: /\w+/g}}, pattern: /(instanceof)\s([^\$].*?)(\)|;)/g},
    {matches: {1: "support.function"}, pattern: /\b(array(_key_exists|_merge|_keys|_shift)?|isset|count|empty|unset|printf|is_(array|string|numeric|object)|sprintf|each|date|time|substr|pos|str(len|pos|tolower|_replace|totime)?|ord|trim|in_array|implode|end|preg_match|explode|fmod|define|link|list|get_class|serialize|file|sort|mail|dir|idate|log|intval|header|chr|function_exists|dirname|preg_replace|file_exists)(?=\()/g},
    {name: "variable.language.php-tag", pattern: /(&lt;\?(php)?|\?&gt;)/g},
    {matches: {1: "keyword.namespace", 2: {name: "support.namespace", pattern: /\w+/g}}, pattern: /\b(namespace|use)\s(.*?);/g},
    ...
    {matches: {1: "storage.function", 2: "support.magic"}, pattern: /(function)\s(__.*?)(?=\()/g},
    {matches: {1: "keyword.new", 2: {name: "support.class", pattern: /\w+/g}}, pattern: /\b(new)\s([^\$].*?)(?=\)|\(|;)/g},
    {matches: {1: {name: "support.class", pattern: /\w+/g}, 2: "keyword.static"}, pattern: /([\w\\]*?)(::)(?=\b|\$)/g},
    {matches: {2: {name: "support.class", pattern: /\w+/g}}, pattern: /(\(|,\s?)([\w\\]*?)(?=\s\$)/g}
]);
Rainbow.extend("python", [
    {name: "variable.self", pattern: /self/g},
    {name: "constant.language", pattern: /None|True|False/g},
    ...
    {matches: {1: "keyword"}, pattern: /\b(pass|lambda|with|is|not|in|from|elif)(?=\(|\b)/g},
    {matches: {1: "storage.class", 2: "entity.name.class", 3: "entity.other.inherited-class"}, pattern: /(class)\s+(\w+)\((\w+?)\)/g},
    {matches: {1: "storage.function", 2: "support.magic"}, pattern: /(def)\s+(__\w+)(?=\()/g},
    {name: "support.magic", pattern: /__(name)__/g},
    {matches: {1: "keyword.control", 2: "support.exception.type"}, pattern: /(except) (\w+):/g},
...
Rainbow.extend("r", [
    {matches: {1: {name: "keyword.operator", pattern: /\=|<\-|&lt;-/g}, 2: {name: "string", matches: {name: "constant.character.escape", pattern: /\\('|"){1}/g}}}, pattern: /(\(|\s|\[|\=|:)(('|")([^\\\1]|\\.)*?(\3))/gm},
    {matches: {1: "constant.language"}, pattern: /\b(NULL|NA|TRUE|FALSE|T|F|NaN|Inf|NA_integer_|NA_real_|NA_complex_|NA_character_)\b/g},
    {matches: {1: "constant.symbol"}, pattern: /[^0-9a-zA-Z\._](LETTERS|letters|month\.(abb|name)|pi)/g},
    {name: "keyword.operator", pattern: /&lt;-|<-|-|==|&lt;=|<=|&gt;>|>=|<|>|&amp;&amp;|&&|&amp;|&|!=|\|\|?|\*|\+|\^|\/|%%|%\/%|\=|%in%|%\*%|%o%|%x%|\$|:|~|\[{1,2}|\]{1,2}/g},
    {matches: {1: "storage", 3: "entity.function"}, pattern: /(\s|^)(.*)(?=\s?=\s?function\s\()/g},
    {matches: {1: "storage.function"}, pattern: /[^a-zA-Z0-9._](function)(?=\s*\()/g},
    {matches: {1: "namespace", 2: "keyword.operator", 3: "function.call"}, pattern: /([a-zA-Z][a-zA-Z0-9._]+)([:]{2,3})([.a-zA-Z][a-zA-Z0-9._]*(?=\s*\())\b/g},
    {name: "support.function", pattern: /(^|[^0-9a-zA-Z\._])(array|character|complex|data\.frame|double|integer|list|logical|matrix|numeric|vector)(?=\s*\()/g}
]);
Rainbow.extend("ruby", [
    {name: "string", matches: {1: "string.open", 2: {name: "string.keyword", pattern: /(\#\{.*?\})/g}, 3: "string.close"}, pattern: /("|`)(.*?[^\\\1])?(\1)/g},
    {name: "string", pattern: /('|"|`)([^\\\1\n]|\\.)*\1/g},
    {name: "string", pattern: /%[qQ](?=(\(|\[|\{|&lt;|.)(.*?)(?:'|\)|\]|\}|&gt;|\1))(?:\(\2\)|\[\2\]|\{\2\}|\&lt;\2&gt;|\1\2\1)/g},
    {matches: {1: "string", 2: "string", 3: "string"}, pattern: /(&lt;&lt;)(\w+).*?$([\s\S]*?^\2)/gm},
    {matches: {1: "string", 2: "string", 3: "string"}, pattern: /(&lt;&lt;\-)(\w+).*?$([\s\S]*?\2)/gm},
    {name: "string.regexp", matches: {1: "string.regexp", 2: {name: "string.regexp", pattern: /\\(.){1}/g}, 3: "string.regexp", 4: "string.regexp"}, pattern: /(\/)(.*?)(\/)([a-z]*)/g},
    {name: "string.regexp", matches: {1: "string.regexp", 2: {name: "string.regexp", pattern: /\\(.){1}/g}, 3: "string.regexp", 4: "string.regexp"}, pattern: /%r(?=(\(|\[|\{|&lt;|.)(.*?)('|\)|\]|\}|&gt;|\1))(?:\(\2\)|\[\2\]|\{\2\}|\&lt;\2&gt;|\1\2\1)([a-z]*)/g},
    {name: "comment", pattern: /#.*$/gm},
    {name: "comment", pattern: /^\=begin[\s\S]*?\=end$/gm},
    {matches: {1: "constant"}, pattern: /(\w+:)[^:]/g},
    {matches: {1: "constant.symbol"}, pattern: /[^:](:(?:\w+|(?=['"](.*?)['"])(?:"\2"|'\2')))/g},
    ...
    {matches: {1: "storage.class", 2: "entity.name.class", 3: "entity.other.inherited-class"}, pattern: /\s*(class)\s+((?:(?:::)?[A-Z]\w*)+)(?:\s+&lt;\s+((?:(?:::)?[A-Z]\w*)+))?/g},
    {matches: {1: "storage.module", 2: "entity.name.class"}, pattern: /\s*(module)\s+((?:(?:::)?[A-Z]\w*)+)/g},
    ...
    {matches: {1: "keyword.control"}, pattern: /[^\.]\b(BEGIN|begin|case|class|do|else|elsif|END|end|ensure|for|if|in|module|rescue|then|unless|until|when|while)\b(?![?!])/g},
    {matches: {1: "keyword.control.pseudo-method"}, pattern: /[^\.]\b(alias|alias_method|break|next|redo|retry|return|super|undef|yield)\b(?![?!])|\bdefined\?|\bblock_given\?/g},
    {matches: {1: "constant.language"}, pattern: /\b(nil|true|false)\b(?![?!])/g},
    {matches: {1: "variable.language"}, pattern: /\b(__(FILE|LINE)__|self)\b(?![?!])/g},
    {matches: {1: "keyword.special-method"}, pattern: /\b(require|gem|initialize|new|loop|include|extend|raise|attr_reader|attr_writer|attr_accessor|attr|catch|throw|private|module_function|public|protected)\b(?![?!])/g},
    {name: "keyword.operator", pattern: /\s\?\s|=|&lt;&lt;|&lt;&lt;=|%=|&=|\*=|\*\*=|\+=|\-=|\^=|\|{1,2}=|&lt;&lt;|&lt;=&gt;|&lt;(?!&lt;|=)|&gt;(?!&lt;|=|&gt;)|&lt;=|&gt;=|===|==|=~|!=|!~|%|&amp;|\*\*|\*|\+|\-|\/|\||~|&gt;&gt;/g},
    {matches: {1: "keyword.operator.logical"}, pattern: /[^\.]\b(and|not|or)\b/g},
    {matches: {1: "storage.function", 2: "entity.name.function"}, pattern: /(def)\s(.*?)(?=(\s|\())/g}
], !0);
Rainbow.extend("scheme", [
    ...
    {matches: {1: "keyword"}, pattern: /\(\s*(begin|define\-syntax|if|lambda|quasiquote|quote|set!|syntax\-rules|and|and\-let\*|case|cond|delay|do|else|or|let|let\*|let\-syntax|letrec|letrec\-syntax)(?=[\]()\s#])/g},
...
(function () {
    ...
    var e = {enterFullScreen: function () {
        ...
        $("code[data-src]", e).each(function (e, t) {
            var n = $(t), r = n.data("src"), i = n.data("language");
            $.get(r, function (e) {
                i === "text" || i === "" ? n.append(e) : Rainbow.color(e, i, function (e) {
                    n.append(e)
                })
            }, "text")
        });
        ...
        e.width() > 778 ? e.animate({width: 778}, 2e3, "linear") : e.width() > 490 ? e.animate({width: 490}, 2e3, "linear") : e.width() > 330 ? e.animate({width: 330}, 2e3, "linear") : e.animate({width: 990}, 2e3, "linear")
    }};
    $(function () {
