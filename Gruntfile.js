...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            dist: {
                //src: ['<%= yeoman.app %>/scripts/plezen/*.js'],//src文件夹下包括子文件夹下的所有文件
                //dest: '<%= yeoman.dist %>/scripts/plezen.js'//合并文件在dist下名为built.js的文件
            }
        },
        uglify: {
            build: {
                files: [
                    {
                        expand: true,
                        cwd: '<%= yeoman.app %>/scripts/extend/plezen',//js目录下
                        src: '*.js',
                        dest: '<%= yeoman.app %>/scripts/plezen'
                    }
                ]
            }
        }
